...
psedit .\EnableAccessFromWindowsmgmtVM.ps1
...
ssh -L 6515:192.168.2.4:6516 username@somedomain.onmicrosoft.com@$PublicIP -N

# Open WAC (https://localhost:6515) and add VM Scale Set instances using their private IP addresses
