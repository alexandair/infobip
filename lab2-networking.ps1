...
$resourceGroupName = 'infobip-net-NN-rg' # replace NN with some numbers
$vnetName = 'demovnet'
$location = 'westeurope'
...
New-AzNetworkSecurityGroup -Name management_nsg -SecurityRules $rdp -ResourceGroupName $resourceGroupName -Location $location
New-AzNetworkSecurityGroup -Name jumpbox_nsg -SecurityRules $ssh -ResourceGroupName $resourceGroupName -Location $location
New-AzNetworkSecurityGroup -Name frontend_nsg -SecurityRules $web -ResourceGroupName $resourceGroupName -Location $location

$vnet = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroupName

$nsg = Get-AzNetworkSecurityGroup -Name jumpbox_nsg -ResourceGroupName $resourceGroupName
...
$nsg = Get-AzNetworkSecurityGroup -Name management_nsg -ResourceGroupName $resourceGroupName
...
$nsg = Get-AzNetworkSecurityGroup -Name frontend_nsg -ResourceGroupName $resourceGroupName
